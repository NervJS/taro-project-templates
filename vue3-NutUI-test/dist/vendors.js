...
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/slicedToArray */ "./node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
...
function effect(fn) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* EMPTY_OBJ */ "b"];
...
function trigger(target, type, key, newValue, oldValue, oldTarget) {
  ...
  /* CLEAR */
      ...
      depsMap.forEach(add);
    } else if (key === 'length' && Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isArray */ "n"])(target)) {
    ...
    switch (type) {
      ...
      /* ADD */
      :
        if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isArray */ "n"])(target)) {
          add(depsMap.get(ITERATE_KEY));

          if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isMap */ "s"])(target)) {
            add(depsMap.get(MAP_KEY_ITERATE_KEY));
          }
        } else if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isIntegerKey */ "r"])(key)) {
...
var isNonTrackableKeys = /*#__PURE__*/Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* makeMap */ "G"])("__proto__,__v_isRef,__isVue");
var builtInSymbols = new Set(Object.getOwnPropertyNames(Symbol).map(function (key) {
  return Symbol[key];
}).filter(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isSymbol */ "D"]));
...
function createGetter() {
  ...
  return function get(target, key, receiver) {
    ...
    var targetIsArray = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isArray */ "n"])(target);

    if (!isReadonly && targetIsArray && Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* hasOwn */ "k"])(arrayInstrumentations, key)) {
      return Reflect.get(arrayInstrumentations, key, receiver);
    }

    var res = Reflect.get(target, key, receiver);

    if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isSymbol */ "D"])(key) ? builtInSymbols.has(key) : isNonTrackableKeys(key)) {
      return res;
    }
    ...
    if (isRef(res)) {
      ...
      var shouldUnwrap = !targetIsArray || !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isIntegerKey */ "r"])(key);
      return shouldUnwrap ? res.value : res;
    }

    if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isObject */ "u"])(res)) {
...
function createSetter() {
  ...
  return function set(target, key, value, receiver) {
    ...
    if (!shallow) {
      ...
      if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isArray */ "n"])(target) && isRef(oldValue) && !isRef(value)) {
        oldValue.value = value;
        return true;
      }
    }

    var hadKey = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isArray */ "n"])(target) && Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isIntegerKey */ "r"])(key) ? Number(key) < target.length : Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* hasOwn */ "k"])(target, key);
    ...
    if (target === toRaw(receiver)) {
      if (!hadKey) {
        ...
        /* ADD */
        , key, value);
      } else if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* hasChanged */ "j"])(value, oldValue)) {
        trigger(target, "set"
        /* SET */
        , key, value, oldValue);
      }
...
function deleteProperty(target, key) {
  var hadKey = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* hasOwn */ "k"])(target, key);
  var oldValue = target[key];
...
function has(target, key) {
  ...
  if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isSymbol */ "D"])(key) || !builtInSymbols.has(key)) {
    track(target, "has"
    /* HAS */
    , key);
  }
...
function ownKeys(target) {
  ...
  /* ITERATE */
  , Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isArray */ "n"])(target) ? 'length' : ITERATE_KEY);
...
var shallowReactiveHandlers = /*#__PURE__*/Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* extend */ "h"])({}, mutableHandlers, {
  get: shallowGet,
  set: shallowSet
...
var shallowReadonlyHandlers = /*#__PURE__*/Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* extend */ "h"])({}, readonlyHandlers, {
  get: shallowReadonlyGet
});

var toReactive = function toReactive(value) {
  return Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isObject */ "u"])(value) ? reactive(value) : value;
};

var toReadonly = function toReadonly(value) {
  return Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isObject */ "u"])(value) ? readonly(value) : value;
};
...
function clear() {
  ...
  var oldTarget =  true ? Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isMap */ "s"])(target) ? new Map(target) : new Set(target) : undefined; // forward the operation before queueing reactions
...
function createIterableMethod(method, isReadonly, isShallow) {
  return function () {
    ...
    var rawTarget = toRaw(target);
    var targetIsMap = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isMap */ "s"])(rawTarget);
    ...
    return Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])({
      // iterator protocol
      next: function next() {
...
function createReadonlyMethod(type) {
  return function () {
    if (true) {
      ...
      console.warn("".concat(Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* capitalize */ "f"])(type), " operation ").concat(key, "failed: target is readonly."), toRaw(this));
    }
...
var _createInstrumentatio = /* #__PURE__*/createInstrumentations(),
    _createInstrumentatio2 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_createInstrumentatio, 4),
...
function createInstrumentationGetter(isReadonly, shallow) {
  ...
  return function (target, key, receiver) {
    ...
    return Reflect.get(Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* hasOwn */ "k"])(instrumentations, key) && key in target ? instrumentations : target, key, receiver);
  };
}
...
function checkIdentityKeys(target, has, key) {
  ...
  if (rawKey !== key && has.call(target, rawKey)) {
    var type = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* toRawType */ "N"])(target);
...
function getTargetType(value) {
  ...
  /* INVALID */
  : targetTypeMap(Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* toRawType */ "N"])(value));
}
...
function createReactiveObject(target, isReadonly, baseHandlers, collectionHandlers, proxyMap) {
  if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isObject */ "u"])(target)) {
    if (true) {
...
function markRaw(value) {
  Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* def */ "g"])(value, "__v_skip"
  /* SKIP */
  , true);
  return value;
}
...
var convert = function convert(val) {
  return Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isObject */ "u"])(val) ? reactive(val) : val;
};
...
var RefImpl = /*#__PURE__*/function () {
  function RefImpl(_rawValue, _shallow) {
    Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, RefImpl);
  ...
  Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(RefImpl, [{
    key: "value",
    get: function get() {
    ...
    set: function set(newVal) {
      if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* hasChanged */ "j"])(toRaw(newVal), this._rawValue)) {
...
var CustomRefImpl = /*#__PURE__*/function () {
  function CustomRefImpl(factory) {
    ...
    Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, CustomRefImpl);
  ...
  Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(CustomRefImpl, [{
    key: "value",
    get: function get() {
      return this._get();
    },
...
function toRefs(object) {
  ...
  var ret = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isArray */ "n"])(object) ? new Array(object.length) : {};
...
var ObjectRefImpl = /*#__PURE__*/function () {
  function ObjectRefImpl(_object, _key) {
    Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, ObjectRefImpl);
  ...
  Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(ObjectRefImpl, [{
    key: "value",
    get: function get() {
...
var ComputedRefImpl = /*#__PURE__*/function () {
  function ComputedRefImpl(getter, _setter, isReadonly) {
    ...
    Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, ComputedRefImpl);
  ...
  Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(ComputedRefImpl, [{
    key: "value",
    get: function get() {
...
function computed(getterOrOptions) {
  ...
  if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isFunction */ "o"])(getterOrOptions)) {
  ...
  return new ComputedRefImpl(getter, setter, Object(_vue_shared__WEBPACK_IMPORTED_MODULE_4__[/* isFunction */ "o"])(getterOrOptions) || !getterOrOptions.set);
}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return Teleport; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return createTextVNode; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return onBeforeMount; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return onBeforeUnmount; });
/* unused harmony export onBeforeUpdate */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return onDeactivated; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return renderSlot; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return resolveComponent; });
...
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/typeof */ "./node_modules/@babel/runtime/helpers/esm/typeof.js");
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/slicedToArray */ "./node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var _Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
...
function warn(msg) {
  ...
  if (appWarnHandler) {
    ...
    !false) {
      warnArgs.push.apply(warnArgs, ["\n"].concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(formatTrace(trace))));
    }

    (_console = console).warn.apply(_console, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(warnArgs));
  }
...
function formatTrace(trace) {
  ...
  trace.forEach(function (entry, i) {
    logs.push.apply(logs, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(i === 0 ? [] : ["\n"]).concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(formatTraceEntry(entry))));
  });
  return logs;
}
...
function formatTraceEntry(_ref2) {
  ...
  var close = ">" + postfix;
  return vnode.props ? [open].concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(formatProps(vnode.props)), [close]) : [open + close];
}
/* istanbul ignore next */
...
function formatProps(props) {
  ...
  keys.slice(0, 3).forEach(function (key) {
    res.push.apply(res, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(formatProp(key, props[key])));
  });
...
var ErrorTypeStrings = (_ErrorTypeStrings = {}, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "sp"
/* SERVER_PREFETCH */
, 'serverPrefetch hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "bc"
/* BEFORE_CREATE */
, 'beforeCreate hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "c"
/* CREATED */
, 'created hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "bm"
/* BEFORE_MOUNT */
, 'beforeMount hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "m"
/* MOUNTED */
, 'mounted hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "bu"
/* BEFORE_UPDATE */
, 'beforeUpdate hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "u"
/* UPDATED */
, 'updated'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "bum"
/* BEFORE_UNMOUNT */
, 'beforeUnmount hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "um"
/* UNMOUNTED */
, 'unmounted hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "a"
/* ACTIVATED */
, 'activated hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "da"
/* DEACTIVATED */
, 'deactivated hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "ec"
/* ERROR_CAPTURED */
, 'errorCaptured hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "rtc"
/* RENDER_TRACKED */
, 'renderTracked hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, "rtg"
/* RENDER_TRIGGERED */
, 'renderTriggered hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 0
/* SETUP_FUNCTION */
, 'setup function'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 1
/* RENDER_FUNCTION */
, 'render function'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 2
/* WATCH_GETTER */
, 'watcher getter'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 3
/* WATCH_CALLBACK */
, 'watcher callback'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 4
/* WATCH_CLEANUP */
, 'watcher cleanup function'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 5
/* NATIVE_EVENT_HANDLER */
, 'native event handler'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 6
/* COMPONENT_EVENT_HANDLER */
, 'component event handler'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 7
/* VNODE_HOOK */
, 'vnode hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 8
/* DIRECTIVE_HOOK */
, 'directive hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 9
/* TRANSITION_HOOK */
, 'transition hook'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 10
/* APP_ERROR_HANDLER */
, 'app errorHandler'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 11
/* APP_WARN_HANDLER */
, 'app warnHandler'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 12
/* FUNCTION_REF */
, 'ref function'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 13
/* ASYNC_COMPONENT_LOADER */
, 'async component loader'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_ErrorTypeStrings, 14
/* SCHEDULER */
...
function callWithErrorHandling(fn, instance, type, args) {
  ...
  try {
    res = args ? fn.apply(void 0, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(args)) : fn();
  } catch (err) {
...
function queueCb(cb, activeQueue, pendingQueue, index) {
  if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* isArray */ "n"])(cb)) {
    ...
    pendingQueue.push.apply(pendingQueue, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(cb));
  }
...
function flushPreFlushCbs(seen) {
  ...
  if (pendingPreFlushCbs.length) {
    ...
    activePreFlushCbs = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(new Set(pendingPreFlushCbs));
...
function flushPostFlushCbs(seen) {
  if (pendingPostFlushCbs.length) {
    var deduped = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(new Set(pendingPostFlushCbs));
    ...
    if (activePostFlushCbs) {
      ...
      (_activePostFlushCbs = activePostFlushCbs).push.apply(_activePostFlushCbs, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(deduped));
...
var deprecationData = (_deprecationData = {}, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_MOUNT"
/* GLOBAL_MOUNT */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_MOUNT_CONTAINER"
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_EXTEND"
/* GLOBAL_EXTEND */
, {
  message: "Vue.extend() has been removed in Vue 3. " + "Use defineComponent() instead.",
  link: "https://v3.vuejs.org/api/global-api.html#definecomponent"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_PROTOTYPE"
/* GLOBAL_PROTOTYPE */
, {
  message: "Vue.prototype is no longer available in Vue 3. " + "Use app.config.globalProperties instead.",
  link: "https://v3.vuejs.org/guide/migration/global-api.html#vue-prototype-replaced-by-config-globalproperties"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_SET"
/* GLOBAL_SET */
, {
  message: "Vue.set() has been removed as it is no longer needed in Vue 3. " + "Simply use native JavaScript mutations."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_DELETE"
/* GLOBAL_DELETE */
, {
  message: "Vue.delete() has been removed as it is no longer needed in Vue 3. " + "Simply use native JavaScript mutations."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_OBSERVABLE"
/* GLOBAL_OBSERVABLE */
, {
  message: "Vue.observable() has been removed. " + "Use `import { reactive } from \"vue\"` from Composition API instead.",
  link: "https://v3.vuejs.org/api/basic-reactivity.html"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "GLOBAL_PRIVATE_UTIL"
/* GLOBAL_PRIVATE_UTIL */
, {
  message: "Vue.util has been removed. Please refactor to avoid its usage " + "since it was an internal API even in Vue 2."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CONFIG_SILENT"
/* CONFIG_SILENT */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CONFIG_DEVTOOLS"
/* CONFIG_DEVTOOLS */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CONFIG_KEY_CODES"
/* CONFIG_KEY_CODES */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CONFIG_PRODUCTION_TIP"
/* CONFIG_PRODUCTION_TIP */
, {
  message: "config.productionTip has been removed.",
  link: "https://v3.vuejs.org/guide/migration/global-api.html#config-productiontip-removed"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CONFIG_IGNORED_ELEMENTS"
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CONFIG_WHITESPACE"
/* CONFIG_WHITESPACE */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CONFIG_OPTION_MERGE_STRATS"
/* CONFIG_OPTION_MERGE_STRATS */
, {
  message: "config.optionMergeStrategies no longer exposes internal strategies. " + "Use custom merge functions instead."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_SET"
/* INSTANCE_SET */
, {
  message: "vm.$set() has been removed as it is no longer needed in Vue 3. " + "Simply use native JavaScript mutations."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_DELETE"
/* INSTANCE_DELETE */
, {
  message: "vm.$delete() has been removed as it is no longer needed in Vue 3. " + "Simply use native JavaScript mutations."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_DESTROY"
/* INSTANCE_DESTROY */
, {
  message: "vm.$destroy() has been removed. Use app.unmount() instead.",
  link: "https://v3.vuejs.org/api/application-api.html#unmount"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_EVENT_EMITTER"
/* INSTANCE_EVENT_EMITTER */
, {
  message: "vm.$on/$once/$off() have been removed. " + "Use an external event emitter library instead.",
  link: "https://v3.vuejs.org/guide/migration/events-api.html"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_EVENT_HOOKS"
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_CHILDREN"
/* INSTANCE_CHILDREN */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_LISTENERS"
/* INSTANCE_LISTENERS */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_SCOPED_SLOTS"
/* INSTANCE_SCOPED_SLOTS */
, {
  message: "vm.$scopedSlots has been removed. Use vm.$slots instead.",
  link: "https://v3.vuejs.org/guide/migration/slots-unification.html"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "INSTANCE_ATTRS_CLASS_STYLE"
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "OPTIONS_DATA_FN"
/* OPTIONS_DATA_FN */
, {
  message: "The \"data\" option can no longer be a plain object. " + "Always use a function.",
  link: "https://v3.vuejs.org/guide/migration/data-option.html"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "OPTIONS_DATA_MERGE"
/* OPTIONS_DATA_MERGE */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "OPTIONS_BEFORE_DESTROY"
/* OPTIONS_BEFORE_DESTROY */
, {
  message: "`beforeDestroy` has been renamed to `beforeUnmount`."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "OPTIONS_DESTROYED"
/* OPTIONS_DESTROYED */
, {
  message: "`destroyed` has been renamed to `unmounted`."
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "WATCH_ARRAY"
/* WATCH_ARRAY */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "PROPS_DEFAULT_THIS"
/* PROPS_DEFAULT_THIS */
, {
  message: function message(key) {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "CUSTOM_DIR"
/* CUSTOM_DIR */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "V_FOR_REF"
/* V_FOR_REF */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "V_ON_KEYCODE_MODIFIER"
/* V_ON_KEYCODE_MODIFIER */
, {
  message: "Using keyCode as v-on modifier is no longer supported. " + "Use kebab-case key name modifiers instead.",
  link: "https://v3.vuejs.org/guide/migration/keycode-modifiers.html"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "ATTR_FALSE_VALUE"
/* ATTR_FALSE_VALUE */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "ATTR_ENUMERATED_COERCION"
...
, {
  ...
  link: "https://v3.vuejs.org/guide/migration/attribute-coercion.html"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "TRANSITION_CLASSES"
/* TRANSITION_CLASSES */
, {
  message: "" // this feature cannot be runtime-detected

}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "TRANSITION_GROUP_ROOT"
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "COMPONENT_ASYNC"
/* COMPONENT_ASYNC */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "COMPONENT_FUNCTIONAL"
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "COMPONENT_V_MODEL"
/* COMPONENT_V_MODEL */
, {
  message: function message(comp) {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "RENDER_FUNCTION"
/* RENDER_FUNCTION */
, {
...
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "FILTERS"
/* FILTERS */
, {
  message: "filters have been removed in Vue 3. " + "The \"|\" symbol will be treated as native JavaScript bitwise OR operator. " + "Use method calls or computed properties instead.",
  link: "https://v3.vuejs.org/guide/migration/filters.html"
}), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_deprecationData, "PRIVATE_APIS"
/* PRIVATE_APIS */
, {
  message: function message(name) {
...
function emit(instance, event) {
  ...
  if (true) {
    var emitsOptions = instance.emitsOptions,
        _instance$propsOption = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(instance.propsOptions, 1),
...
function renderComponentRoot(instance) {
  var Component = instance.type,
      ...
      _instance$propsOption2 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(instance.propsOptions, 1),
  ...
  try {
    ...
    /* DEV_ROOT_FRAGMENT */
        ...
        var _getChildRoot2 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_getChildRoot, 2);
  ...
  var setRoot = function setRoot(updatedRoot) {
    ...
    if (dynamicChildren) {
      if (dynamicIndex > -1) {
        ...
        vnode.dynamicChildren = [].concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(dynamicChildren), [updatedRoot]);
      }
    }
  };
    ...
    resolve: function resolve() {
      ...
      while (parent) {
        if (parent.pendingBranch) {
          ...
          // into that parent
          (_parent$effects = parent.effects).push.apply(_parent$effects, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(effects));
...
function queueEffectWithSuspense(fn, suspense) {
  if (suspense && suspense.pendingBranch) {
    if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* isArray */ "n"])(fn)) {
      ...
      (_suspense$effects = suspense.effects).push.apply(_suspense$effects, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(fn));
    } else {
...
function traverse(value) {
  ...
  if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* isObject */ "u"])(value) || seen.has(value) || value["__v_skip"
  /* SKIP */
  ]) {
    return value;
  }
...
var KeepAliveImpl = {
  ...
  setup: function setup(props, _ref9) {
    ...
    watch(function () {
      ...
      var _ref11 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_ref10, 2),
          include = _ref11[0],
          exclude = _ref11[1];
...
function applyOptions(instance) {
  ...
  if (true) {
    var _instance$propsOption3 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(instance.propsOptions, 1),
  ...
  if (methods) {
    for (var _key5 in methods) {
      ...
      if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "o"])(methodHandler)) {
        ...
        warn("Method \"".concat(_key5, "\" has type \"").concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(methodHandler), "\" in the component definition. ") + "Did you reference the function correctly?");
      }
    }
  }
...
function mergeAsArray(to, from) {
  return to ? Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(new Set([].concat(to, from))) : from;
}
...
function updateProps(instance, rawProps, rawPrevProps, optimized) {
  ...
  var _instance$propsOption4 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(instance.propsOptions, 1),
  ...
  /* FULL_PROPS */
    ...
    for (var _key9 in rawCurrentProps) {
      ...
      !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* hasOwn */ "k"])(rawProps, _key9) && ( // it's possible the original props was passed in as kebab-case
      // and converted to camelCase (#955)
      (kebabKey = Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* hyphenate */ "l"])(_key9)) === _key9 || !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* hasOwn */ "k"])(rawProps, kebabKey))) {
        if (options) {
...
function setFullProps(instance, rawProps, props, attrs) {
  var _instance$propsOption5 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(instance.propsOptions, 2),
  ...
  if ( true && !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "o"])(comp)) {
    var extendProps = function extendProps(raw) {
      ...
      var _normalizePropsOption = normalizePropsOptions(raw, appContext, true),
          _normalizePropsOption2 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_normalizePropsOption, 2),
          props = _normalizePropsOption2[0],
          keys = _normalizePropsOption2[1];

      Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* extend */ "h"])(normalized, props);
      if (keys) needCastKeys.push.apply(needCastKeys, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(keys));
    };
...
function assertType(value, type) {
  ...
  if (isSimpleType(expectedType)) {
    var t = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(value);
...
function withDirectives(vnode, directives) {
  ...
  for (var i = 0; i < directives.length; i++) {
    var _directives$i = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(directives[i], 4),
        dir = _directives$i[0],
    ...
    switch (type) {
      ...
      default:
        ...
        /* SUSPENSE */
          ...
          warn('Invalid HostVNode type:', type, "(".concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(type), ")"));
        }
...
var setRef = function setRef(rawRef, oldRawRef, parentSuspense, vnode) {
  ...
  if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* isString */ "C"])(ref)) {
    ...
    warn('Invalid template ref type:', value, "(".concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(value), ")"));
  }
};
/**
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    switch (type) {
      ...
      default:
        ...
        /* SUSPENSE */
          ...
          warn('Invalid VNode type:', type, "(".concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(type), ")"));
        }
  ...
  var patchStaticNode = function patchStaticNode(n1, n2, container, isSVG) {
    ...
    if (n2.children !== n1.children) {
      ...
      var _hostInsertStaticCont2 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_hostInsertStaticCont, 2);
  ...
  if (createHydrationFns) {
    ...
    var _createHydrationFns2 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_createHydrationFns, 2);
  ...
  process: function (_process) {
    ...
    if (n1 == null) {
      ...
      if (target) {
        ...
        warn('Invalid Teleport target on mount:', target, "(".concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(target), ")"));
      }
      ...
      if (disabled) {
        ...
        if ((n2.props && n2.props.to) !== (n1.props && n1.props.to)) {
          ...
          if (nextTarget) {
            ...
            warn('Invalid Teleport target on update:', _target, "(".concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_target), ")"));
          }
        } else if (wasDisabled) {
          // disabled -> enabled
...
var createVNodeWithArgsTransform = function createVNodeWithArgsTransform() {
  ...
  return _createVNode.apply(void 0, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(vnodeArgsTransformer ? vnodeArgsTransformer(args, currentRenderingInstance) : args));
};
...
function normalizeVNode(child) {
  if (child == null || typeof child === 'boolean') {
    ...
    child.slice());
  } else if (Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(child) === 'object') {
...
function normalizeChildren(vnode, children) {
  ...
  if (children == null) {
    ...
    /* ARRAY_CHILDREN */
    ;
  } else if (Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(children) === 'object') {
    if (shapeFlag & 1
    /* ELEMENT */
    || shapeFlag & 64
    /* TELEPORT */
...
function exposePropsOnRenderContext(instance) {
  var ctx = instance.ctx,
      _instance$propsOption6 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(instance.propsOptions, 1),
...
function handleSetupResult(instance, setupResult, isSSR) {
  if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "o"])(setupResult)) {
    ...
    warn("setup() should return an object. Received: ".concat(setupResult === null ? 'null' : Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(setupResult)));
  }
...
var isObject = function isObject(val) {
  return val !== null && Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(val) === 'object';
};
...
function initCustomFormatter() {
  ...
  var formatter = {
    ...
    body: function body(obj) {
      if (obj && obj.__isVue) {
        return ['div', {}].concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(formatInstance(obj.$)));
      }
    }
  };
  ...
  function createInstanceBlock(type, target) {
    ...
    }].concat(Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Object.keys(target).map(function (key) {
...
var PatchFlagNames = (_PatchFlagNames = {}, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 1
/* TEXT */
, "TEXT"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 2
/* CLASS */
, "CLASS"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 4
/* STYLE */
, "STYLE"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 8
/* PROPS */
, "PROPS"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 16
/* FULL_PROPS */
, "FULL_PROPS"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 32
/* HYDRATE_EVENTS */
, "HYDRATE_EVENTS"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 64
/* STABLE_FRAGMENT */
, "STABLE_FRAGMENT"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 128
/* KEYED_FRAGMENT */
, "KEYED_FRAGMENT"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 256
/* UNKEYED_FRAGMENT */
, "UNKEYED_FRAGMENT"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 512
/* NEED_PATCH */
, "NEED_PATCH"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 1024
/* DYNAMIC_SLOTS */
, "DYNAMIC_SLOTS"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, 2048
/* DEV_ROOT_FRAGMENT */
, "DEV_ROOT_FRAGMENT"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, -1
/* HOISTED */
, "HOISTED"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_PatchFlagNames, -2
/* BAIL */
...
var slotFlagsText = (_slotFlagsText = {}, Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_slotFlagsText, 1
/* STABLE */
, 'STABLE'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_slotFlagsText, 2
/* DYNAMIC */
, 'DYNAMIC'), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_slotFlagsText, 3
/* FORWARDED */
...
var replacer = function replacer(_key, val) {
  if (isMap(val)) {
    return Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])({}, "Map(".concat(val.size, ")"), Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(val.entries()).reduce(function (entries, _ref) {
      var _ref2 = Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_ref, 2),
          key = _ref2[0],
          val = _ref2[1];
...
var isSymbol = function isSymbol(val) {
  return Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(val) === 'symbol';
};
...
var Container = function () {
  function Container(containerOptions) {
    ...
    if (Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(options) !== "object") {
...
function getServiceIdentifierAsString(serviceIdentifier) {
  ...
  } else if (Object(_Users_suzigang_Documents_project_taro_project_templates_vue3_NutUI_test_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(serviceIdentifier) === "symbol") {
